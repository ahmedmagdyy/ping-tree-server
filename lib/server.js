...
} = require('./target/targetController')

const { getRouteDecisionHandler } = require('./route/routeController')
...
router.set('/api/targets', {
  POST: addTargetHandler,
  GET: getTargetsHandler
})
router.set('/api/targets/:id', {
  GET: getTargetByIdHandler,
  POST: updateTargetByIdHandler
})
router.set('/route', { POST: getRouteDecisionHandler })
